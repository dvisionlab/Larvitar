function getMax(arr) {
  ...
  function apply_DSA_Mask(multiFrameSerie, frameId,i) {
    ...
    const mask_type = metadataInfo.x00286101; // Mask Operation Attribute
    let frame_index_number = metadataInfo.x00286110; // Mask Frame Numbers Attribute (might be an array)
