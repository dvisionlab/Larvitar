...
export function apply_DSA_Mask(
  ...
  const frameId=multiFrameSerie.instances["multiFrameLoader://0?frame="+frame_index_number]
  if(mask_type==="NONE")
  {
    return;
  }
  ...
  {
     /*(Average Subtraction) The frames specified by the Mask Frame Numbers x00286110 
     are averaged together, shifted by the amount specified in the Mask Sub-pixel Shift x00286114, 
