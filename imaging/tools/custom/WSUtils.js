 ...
 * @returns {void}
 */
export function toggleUIVisibility(showBrush, showLoader, drawHandlesOnHover) {
 ...
 * @returns {void}
 */
export function shiftAndZeroOut(array, minAppearance) {
  const shiftMap = {};
  let shiftValue = 0;
 ...
 * @returns {void}
 */
export function preProcess(gray, src) {
 ...
 * @returns {cv.Mat}
 */
export function postProcess(markers) {
 ...
 * @returns {void}
 */
export function calculateStats(image, imagePixelData, circleArray) {
  let sum = 0;
 ...
 * @returns {void}
 */
export function mapToRange(value, inMin, inMax) {
