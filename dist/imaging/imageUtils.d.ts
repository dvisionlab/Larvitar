 ...
 */
export declare const getPixelTypedArray: (dataSet: CustomDataSet, pixelDataElement: any) => Uint16Array | Uint8Array | Float64Array | Int8Array | Int16Array | Int32Array | Uint32Array | Float32Array;
/**
 ...
 */
export declare const getSortedStack: (seriesData: Series, sortPriorities: string[], returnSuccessMethod: boolean) => string[];
/**
 ...
 */
export declare const getReslicedMetadata: (reslicedSeriesId: string, fromOrientation: string, toOrientation: string, seriesData: Series, imageLoaderName: string) => {
    imageIds: string[];
    instances: {
 ...
 */
export declare const getReslicedPixeldata: (imageId: string, originalData: Series, reslicedData: Series) => Uint16Array | Uint8Array | Float64Array | Int8Array | Int16Array | Int32Array | Uint32Array | Float32Array;
/**
