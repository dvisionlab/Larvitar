 ...
 */
import { Series, Header } from "./types";
/**
 ...
 */
export declare const buildData: (series: Series, useSeriesData: boolean) => Uint16Array | Uint8Array | Float64Array | Int8Array | Int16Array | Int32Array | Uint32Array | Float32Array | undefined;
/**
 ...
 */
export declare const buildDataAsync: (series: Series, time: number, resolve: Function, reject: Function) => void;
/**
