 ...
 * @returns {void}
 */
export declare const applyColormap: (viewport: _cornerstone.VolumeViewport, colormap: Colormap, voi?: VOI | null) => void;
/**
 ...
 * @returns {void}
 */
export declare const applyColormapByName: (viewport: _cornerstone.VolumeViewport, colormapName: string, voi?: VOI | null) => void;
/**
