...
export declare function registerAllMetadataProviders(): void;
export declare function addMetadataForImageId(imageId: string, metadata: MetaData): void;
/**
 ...
 * @returns {void}
 */
export declare const registerMetadataProviders: () => void;
