...
import { MetaData, RenderProps, Series } from "../imaging/types";
 ...
 */
export declare const renderVideo: (series: Series, renderingEngineId: string, frameNumber?: number) => Promise<unknown>;
/**
