 ...
 */
const getPixelTypedArray = function (dataSet, pixelDataElement) {
  let pixels;
 ...
 */
const getReslicedMetadata = function (
  reslicedSeriesId,
  fromOrientation,
  toOrientation,
  seriesData,
 ...
 * @return {Object} - Cornerstone series object, filled only with metadata
 */
const getCmprMetadata = function (reslicedSeriesId, imageLoaderName, header) {
  let reslicedImageIds = [];
  let reslicedInstances = {};
 ...
 */
var getReslicedPixeldata = function (imageId, originalData, reslicedData) {
 ...
 */
const getDistanceBetweenSlices = function (
  seriesData,
  sliceIndex1,
  sliceIndex2
) {
 ...
 */
function remapVoxel([i, j, k], fromOrientation, toOrientation) {
